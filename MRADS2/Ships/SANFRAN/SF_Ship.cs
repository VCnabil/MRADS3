...
namespace MRADS.Ships.SANFRAN
{
    public class SF_Ship //: MRADSShip
    {
        ...
        protected override void InitControlUnit(MRADSControlUnit CU)
        {
            ...
            var pdecoder = CU.AddParameterPGN(0xff8c);
        ...
        static readonly (int index, string name)[] ParameterList = new (int index, string name)[]
       {
        ...
        public SF_Ship( )  
        {
            ControlUnits.Add(new MRADSControlUnit("Port Control Unit", 0x29, "isprefix", 2));
           // ClutchPanels.Add(new MRADSClutchPanel("the Clutch Panel", 0x34, "clu", 2));
